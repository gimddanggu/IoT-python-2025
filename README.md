...
- Tkinter 학습
    ...
    root = Tk()
    # 이 사이에 위젯, 이벤트 등 작성
    # Label, Button, Entry, Radionbutton
    # Checkbutton, ListBox, Frame 등 ..
    # 위젯.pack() 필수!
    root.mainloop()
    ```
<!-- 주석 -->
<!-- html에서 사용하는 <img> 태그로 캡처 -->
...
https://github.com/user-attachments/assets/ec5ec7e4-c6dc-48fb-9151-94b5bbeb90e7
...
- 파이썬 응용
    - 실행파일 만들기
        ...
        - 실행파일 명령어 (터미널에서 실행)
            ...
            - 같이 실행되는 터미널을 제거하려면
            - pyinstaller --onefile --noconsole python_file.py
            - 아이콘등의 리소스를 넣을 때는 dist폴더에 복사 필요
